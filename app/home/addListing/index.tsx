        ...
        >
            ...
            <View className='pr-4 w-3/5'> 
              <View className='flex-row items-center'>
                ...
                <ThemedText
                  content='Sell'
                  type='heading'
                  otherStyles='text-light-primary dark:text-dark-primary'
                />
              </View>
              
              <ThemedText
                content='Hassle-Free Dealings, Everything’s on Us'
                type='content'
              />
          ...
          <View className='p-4 my-2 rounded-xl bg-light-card dark:bg-dark-card flex-row items-center'>
            <View className='pr-4 w-3/5'> 
              ...
              <ThemedText
                content='Post an AD for FREE and reach thousands of Buyers'
                type='content'
              />
          ...
          <View className='p-6 rounded-xl bg-light-card dark:bg-dark-card items-center space-y-1'>
            <ThemedText
            type='heading'
            content='Why should you Trust Us?'
            />
            ...
            <View className='flex-row gap-2'>
              ...
              <View className='p-4 mt-5 w-1/2  rounded-xl bg-light-card dark:bg-dark-card items-center'>
                ...
                <ThemedText
                  type='content'
                  content={`Pakistan's upcoming marketplace`}
                />
              </View>
